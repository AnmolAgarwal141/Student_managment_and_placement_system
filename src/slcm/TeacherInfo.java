...
public class TeacherInfo extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(users, 0, 162, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if((jTextField2.getText().length())!=0&&(jTextField3.getText().length())!=0&&(jTextField4.getText().length())!=0){
				String Tid = users.getSelectedItem().toString();
                                String name = jTextField3.getText();
                                String branch = jTextField2.getText();
                                int Salary=Integer.parseInt(jTextField4.getText());
                                
				String s = "insert into Teacher(Tid,Tname,Branch,Salary) values(?,?,?,?)";
    ...
    private void fillCombo(){
        try{
            String query = " select * from Tlogin ";
            Connection cc = MyConnection.connect();

...
public class UploadAttendance extends javax.swing.JFrame {
    ...
    /**
     * Creates new form UploadAttendance
     */
    ...
    private void initComponents() {
        ...
        users_table2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Regno", "TotalClasses", "DaysPresent", "DaysAbsent"
            }
        ));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if((jTextField4.getText().length())!=0&&(jTextField5.getText().length())!=0&&(jTextField7.getText().length())!=0){
            ...
            int TotalClasses=Integer.parseInt( jTextField4.getText());
            int DaysPresent=Integer.parseInt(jTextField5.getText());
            int DaysAbsent=Integer.parseInt(jTextField7.getText());

            String s = "insert into Attendance(Regno,subjectcode ,TotalClasses ,DaysPresent ,DaysAbsent) values(?,?,?,?,?)";
            ...
            try{
                ...
                ps.setInt(4,DaysPresent);
                ps.setInt(5,DaysAbsent);
                ps.executeUpdate();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String s="Update Attendance SET TotalClasses=? ,DaysPresent=? ,DaysAbsent=? where Regno=?and subjectcode=?";
        Connection cc = MyConnection.connect();
        try{
            PreparedStatement ps = cc.prepareStatement(s);
    ...
    private void updateTable2(){
        try{
            String subjectcode=users.getSelectedItem().toString();
            String query = "select Regno,TotalClasses,DaysPresent,DaysAbsent from Attendance where subjectcode=?";
            Connection cc = MyConnection.connect();
            PreparedStatement ps = cc.prepareStatement(query);
            ps.setString(1,subjectcode );
          //  ps.setString(1,LOGIN.user);
